...
/**
 * Represents a computer object in the game.
 */
public class Computer extends Object {
     ...
     *
     * @param gamepanel The GamePanel object associated with the computer.
     */
    ...
    /**
     * Loads the computer model images, including effects and text windows.
     */
    ...
    /**
     * Updates the animation frames for the computer and its effects.
     */
    public void Update() {
        frame++;
        if (frame > 10) {
    ...
    /**
     * Draws the computer, its effects, and text windows on the screen.
     *
    ...
    public void Draw(Graphics2D g2) {
        ...
        if (((x * gamePanel.tileSize) < (gamePanel.player.x + gamePanel.player.centerX + gamePanel.tileSize)) &&
            ...
            // Draw computer effects based on game state
            ...
            // Draw text windows and messages based on interaction state
            if (!initializeTeleportation) {
                if (computerInteraction == 1) {
                    ...
                    switch (computerInteraction) {
                        ...
                        default -> initializeTeleportation = true;
                    }
                }
            }
        }
