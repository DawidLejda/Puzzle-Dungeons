...
/**
 * Represents an air vent object in the game.
 */
public class AirVent extends Object {
    ...
    /**
     * Constructor for the AirVent class.
     *
     * @param gamepanel The GamePanel object associated with the air vent.
     */
    ...
    /**
     * Loads the air vent model images.
     */
    ...
    /**
     * Updates the animation frame of the air vent.
     */
    public void Update() {
        frame++;
        if (frame >= 10) {
    ...
    /**
     * Draws the air vent on the screen.
     *
