...
/**
 * Represents a teleportation device in the game.
 */
public class Teleport extends Object {
    ...
    /**
     * Constructor for the Teleport class.
     *
     * @param gamepanel The GamePanel object associated with the teleport.
     */
    ...
    /**
     * Loads the teleport model images, including center, modules, binary bits, and disintegration effects.
     */
    ...
    /**
     * Updates the teleport's state, including animation frames, player interaction, and disintegration effects.
     */
    public void Update() {
        frame++;
        if (frame > 10) {
    ...
    /**
     * Animates the player's disintegration effect.
     */
    void Desintegrate() {
        wait++;
        if (wait > 18) {
        ...
        /**
         * Draws the teleport, its modules, binary bits, and disintegration effects on the screen.
         *
        ...
        public void Draw(Graphics2D g2) {
            ...
            // Check if the teleport is within the visible range of the player
            if ((((x + 2) * gamePanel.tileSize) < (gamePanel.player.x + gamePanel.player.centerX + gamePanel.tileSize)) &&
                ...
                if (!teleportRender) {
                    ...
                    // Draw the teleport modules and binary bits with random flickering effect
