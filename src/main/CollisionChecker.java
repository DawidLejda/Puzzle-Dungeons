...
public class CollisionChecker
{
    ...
    public void CheckTileCollision(Character character)
    {
        ...
        Y[0] = (character.y - gamePanel.tileSize) + (int) (gamePanel.tileSize - (gamePanel.tileSize / 2.05)) + gamePanel.tileSize;
        Y[1] = (character.y + gamePanel.tileSize) - (int) (gamePanel.tileSize - (gamePanel.tileSize / 1.4));
